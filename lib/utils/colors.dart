...
class AppColor {
  ...
  static const mainColor2 = Color(0xFF1de9b6);
  ...
  static const buttonBackendColor = Colors.white38;
  static const signColor = Color(0xFFa9a29f);
  static const titleColor = Color(0xFF5c524f);
  static const mainBlackColor = Color(0xFF000000);
  static const yellowColor = Color(0xFFffd379);
  static const RedSign = Colors.red; // Example color
  static const greenTitle = Colors.green; // Example color
}
